...
<div class="container" style="text-align: right; padding-top: 10px; padding-bottom: 20px;">
    <a class="p-2 border btn btn_style" href="<?php echo base_url('users/register'); ?>">Add New</a>
</div>
